...
export const DATOS_PAGO = {
  ...
  efectivo: {
    nota: "Pago en efectivo al retirar el pedido en el local."
  },
  otro: {
...
// ------------------------------------------------------------
// Poné el precio de cada zona en "precio" (en pesos, sin puntos
// ni comas, ej: 8500). Mientras esté en 0 el sitio igual funciona,
// simplemente va a mostrar "$0" hasta que lo completes.
//
// Si el pedido es de otra provincia (fuera de Buenos Aires), el
// sitio no cotiza un precio: le ofrece a la clienta consultar por
// WhatsApp directamente.
// ============================================================
export const ENVIO_ZONAS = [
  { id: 'caba', nombre: 'CABA (Capital Federal)', precio: 10000 },
  { id: 'gba_norte', nombre: 'GBA Norte (San Isidro, Vicente López, Tigre, San Fernando…)', precio: 0 },
  { id: 'gba_oeste', nombre: 'GBA Oeste (Morón, Merlo, Moreno…)', precio: 0 },
  { id: 'gba_sur', nombre: 'GBA Sur (Avellaneda, Quilmes, Berazategui, Florencio Varela…)', precio: 0 }
];